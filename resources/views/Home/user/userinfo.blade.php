							...
							<form class="am-form am-form-horizontal" action="" method="POST">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" name="name" placeholder="昵称长度不能超过10个汉字" value="">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" name="true_name" id="user-name2" placeholder="name" value="">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content birth">
										<div class="birth-select" id="birthday_y">
										...
										<div class="birth-select2">
											<select data-am-selected id="birthday_m">
											...
											<em>月</em></div>
										<div class="birth-select2">
											<select data-am-selected id="birthday_d">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-phone" placeholder="telephonenumber" type="tel" value="">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-email" placeholder="Email" type="email" value="">
