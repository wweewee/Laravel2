			...
			<div class="am-container header">
				...
				<ul class="message-r">
					...
					<div class="topMessage mini-cart">
						<div class="menu-hd"><a id="mc-menu-hd" href="/home/shopcart/{did}" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
					</div>
					...
					<div class="marqueen">
						...
						<div class="mod-vip">
							...
							<div class="member-logout">
								...
								<a class="am-btn-warning btn" href="{{ url('/home/register') }}">注册</a>
							</div>
